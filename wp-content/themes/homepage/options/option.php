...
class MySettingsPage
{
	...
	{
		add_menu_page(
			'HRM Theme Option',		// Thay title của trang Theme Option
			'Theme Option',			// Thay tên hiển thị trên Menu
			'manage_options',
			'hrm-theme-option',
			array( $this, 'create_admin_page' ),
			get_stylesheet_directory_uri('stylesheet_directory') . '/options/theme_option.png' // Thay icon của bạn
		);
	}
	...
	public function page_init()
	{
		...
		// Thêm các cài đặt của bạn tại đây bằng add_settings_field tương tự như ví dụ ở trên.
	}
